...
class ComingSoonContent extends React.Component {
    ...
    setHide () { this.setState({isShowing: false});}
    getRandomMessage () {
        ...
        return (
            <FormattedMessage
                ...
                values={{ emoji: (<img className={styles.comingSoonImage} src={images[imageNumber]}/> )}}/>);
            }
    render () {
        return (
            <ReactTooltip afterHide={this.setHide} afterShow={this.setShow}
                ...
                getContent={this.getRandomMessage} id={this.props.tooltipId}
            />
        );
    }
}//end of class ComingSoon
