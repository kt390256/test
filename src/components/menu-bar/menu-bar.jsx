...
import ponyLogo from './ponycody.png';
...
const MenuBarItemTooltip = ({ children, className, enable, id, place = 'bottom'}) => {
    ...
    return (
        <ComingSoonTooltip className={classNames(styles.comingSoon, className)}  place={place}
            tooltipClassName={styles.comingSoonTooltip} tooltipId={id}>
            {children}
        </ComingSoonTooltip>
    );
};
